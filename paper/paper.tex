\documentclass[manuscript, screen]{acmart} %removing review removes the numbers on left side
...
\renewcommand{\shortauthors}{Howlett, Spalding} %I don't know how to format this for three authors 
