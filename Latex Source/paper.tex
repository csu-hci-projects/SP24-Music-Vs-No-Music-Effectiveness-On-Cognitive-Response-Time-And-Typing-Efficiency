...
and typing efficiency. A participant would take a typing test and qunatified behavioral test (QBTest) with three conditions.
...
% add results from two tests together
\end{abstract}
