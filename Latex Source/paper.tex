...
\begin{figure}
  ...
  \Description{Heat map of particiant in music with no lyrics}
  \label{fig:music-no-lyrics}
\end{figure}
...
\begin{figure}
  ...
  \Description{Heat map of particiant in music with lyrics}
  \label{fig:music-lyrics}
\end{figure}
