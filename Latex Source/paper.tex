...
The GUI of the typing test was built with simplicity in mind. The starting window was pulled up so as not to confuse participants with the code as seen in Figure 1a. The participants saw Figure 1b while the test is running, while Figure 1c is the signifier that the typing portion is finished. 
